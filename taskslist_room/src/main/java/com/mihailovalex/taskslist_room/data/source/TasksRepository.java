...
public class TasksRepository implements TasksDataSource {
    ...
    public void completeTask(@NonNull Task task) {
        ...
        Task completedTask = new Task(task.getTitle(), task.getTime(), task.getId(), 0L);
    ...
    public void activateTask(@NonNull Task task) {
        ...
        Task activeTask = new Task(task.getTitle(), task.getTime(), task.getId(),task.getGroupId(),false);
