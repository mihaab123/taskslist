...
/**
 * Created by Defender on 30.08.2020.
 */
...
public class IrregularButton extends androidx.appcompat.widget.AppCompatButton {
    ...
    private void initStyleButton(AttributeSet attrs) {
        ...
        for (int i = 0; i < areas.length(); i++) {
            ...
            float pxToDp = 1;//TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 1, res.getDisplayMetrics());
